...
export default function UPSCCoursePage() {
  const { t } = useI18n();
  return (
    <motion.div
    ...
    >
      <h1 className="text-3xl font-semibold tracking-tight mb-2">UPSC {t("courses.course_label")}</h1>
